...
class LSTMRNN(object):
    ...
    def add_input_layer(self,):
        layer_in_x = tf.reshape(self.xs, [-1, self.input_size], name='2_2D')   # (batch*n_step, in_size)
    ...
    def add_cell(self):
        ...
        self.cell_outputs, self.cell_final_state = tf.nn.dynamic_rnn(
            lstm_cell, self.layer_in_y, initial_state=self.cell_init_state, time_major=False
        )
    ...
    def add_output_layer(self):
        ...
        with tf.name_scope('Ws_plus_b'):
            self.prediction = tf.matmul(layer_out_x, Ws_out) + bs_out
    ...
    def _weight_variable(self, shape, name='weoghts'):
...
if __name__ == '__main__':
    ...
    writer = tf.summary.FileWriter("/Users/robinxyuan/Downloads/logs/", sess.graph)
